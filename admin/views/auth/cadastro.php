...
<body>
  ...
  <main>
    <div class="form-wrapper">
      ...
      <div class="eyebrow reveal">Novo cadastro</div>
      <h1 class="reveal reveal-delay-1">Crie sua<br><em>conta.</em></h1>
      ...
      <div class="form-card reveal reveal-delay-2">
        <form action="?url=auth/registrar" method="POST" novalidate>
      ...
      <div class="alt-link reveal reveal-delay-2">
        Já tem uma conta? <a href="?url=auth/login">Entrar →</a>
      </div>
